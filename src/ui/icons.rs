...
pub fn refresh_auth_svg() -> String {
    r#"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><path d="M197.67,186.37a104,104,0,0,1-139.34,0l-4.84,4.84a8,8,0,0,1-11.32-11.32l4.84-4.84a104,104,0,0,1,0-139.34l-4.84-4.84a8,8,0,0,1,11.32-11.32l4.84,4.84a104,104,0,0,1,139.34,0l4.84-4.84a8,8,0,0,1,11.32,11.32l-4.84,4.84a104,104,0,0,1,0,139.34l4.84,4.84a8,8,0,0,1-11.32,11.32ZM187.4,69.4a88,88,0,1,0,0,118.8A88.11,88.11,0,0,0,187.4,69.4Zm-16.68,59.4a8,8,0,0,1-8,8H128a8,8,0,0,1-8-8V88a8,8,0,0,1,16,0v32h26.74A8,8,0,0,1,170.72,128.8Z" fill="currentColor"/></svg>"#.to_string()
}
...
pub fn refresh_svg() -> String {
    r#"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><path d="M224,128A96,96,0,0,1,79.93,211.11a8,8,0,1,1-9.88-12.48A80,80,0,1,0,66.46,67.05l4.63,3.52H72a8,8,0,0,1,0,16H48a8,8,0,0,1-8-8V56a8,8,0,0,1,16,0v5.95l-3.47-2.65a96,96,0,0,1,171.47,68.7Z" fill="currentColor"/></svg>"#.to_string()
}
